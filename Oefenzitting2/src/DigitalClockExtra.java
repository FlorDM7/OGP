 ...
 * Doing it with nominal programming now.
 */
public class DigitalClockExtra {
	 ...
	 * 			| other != null
	 * @pre 	Both clock must have the same minimal and maximal values for their hours.
	 * 			| (this.getMinHours() == other.getMinHours() || this.getMaxHours() == other.getMaxHours())
	...
	public boolean displaysEarlierTimeThan(DigitalClock other) {
		// Both clocks are effective and use the same time display.
